...
namespace ShopMVC.Controllers
{
    public class HangHoasController : Controller
    {
        ...
        public HangHoasController(ShopMvcContext context)
        {
            _context = context;
        }
        ...
        {
            var shopMvcContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await shopMvcContext.ToListAsync());
        }
